...
Route::group([
    ...
    //$router->get('users_list/{token}','dashboardController@users_list');
...
//         $router->get('transaction_history/portfolio/{user_portfolio_id}/{token}','dashboardController@transaction_history_portfolio');
        
//         $router->get('transaction_history_portfolio_add/{token}/{user_id}/{user_portfolio_id}/{amount}/{payment_medium}/{payment_date}/{other_information}','dashboardController@transaction_history_portfolio_add');
